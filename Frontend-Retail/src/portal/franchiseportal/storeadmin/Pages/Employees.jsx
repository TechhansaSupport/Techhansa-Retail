              ...
              <tr key={emp.userId || emp.id} className="hover:bg-slate-50">
                ...
                <td className="px-6 py-4 text-center">
                  <button 
                    ...
                    className={`flex items-center justify-center gap-1 mx-auto px-3 py-1.5 rounded-lg text-xs font-bold ${(emp.status || 'Active') === 'Active' ? 'text-rose-600 bg-rose-50 hover:bg-rose-100' : 'text-emerald-600 bg-emerald-50 hover:bg-emerald-100'}`}
                  >
