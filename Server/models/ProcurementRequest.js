...
const procurementRequestSchema = new mongoose.Schema({
  ...
  status: { type: String, required: true, enum: ['PENDING', 'APPROVED', 'DISPATCHED', 'DELIVERED', 'Quotation Sent', 'Paid', 'Processing', 'PAYMENT_VERIFICATION', 'PAYMENT_REJECTED'], default: 'PENDING' },
