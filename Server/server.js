...
async function startServer() {
  try {
    ...
    console.error('❌ Failed to connect to MongoDB, but starting server anyway for debugging:', error.message);
  }
  
  // Start the Express server regardless of DB status so it doesn't crash NGINX
  app.listen(PORT, () => {
